...
In the **Build** tab of the output panel, you can use the **Engine** dropdown menu to select a supported LaTeX engine.
...
CoCalc can show you current word count statistics generated by texcount_. To see them go to the **Stats** tab of the output panel.

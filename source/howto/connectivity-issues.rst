...
**Remember:** if you don't find what you need, or if you'd like to ask a question, then please email `help@cocalc.com <mailto:help@cocalc.com>`_ at any time. We'd love to hear from you! Please include a link (the URL address in your browser) to any relevant project or document, as part of your email.
...
Step 6: Have you installed browser extensions ("add-on"s) or enabled blocking software on your computer?
----------------------------------------------------------------------------------------------------------------------

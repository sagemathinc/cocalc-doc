...
How to Enable Pay-As-You-Go Upgrades
------------------------------------
...
How to Disable Pay-As-You-Go Upgrades
-------------------------------------

If you decide to use a license/subscription instead, you need to disable your Pay-As-You-Go upgrades:

.. raw:: html

    <center><iframe
        width="640" height="360"
        src="https://www.youtube.com/embed/IehXtozb6Q0?si=BVK6ddnXgsCoWIWy"
        title="YouTube video player"
        frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowfullscreen>
...
.. raw:: html
    ...
    <center><iframe
        width="640" height="360"
        src="https://www.youtube.com/embed/Lqzk_nnlD5w?si=w6HA5xU9KXZkRaJ2"
        title="YouTube video player"
        frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        allowfullscreen>
...
CoCalc Credit Balance Does Not Expire
-------------------------------------

The balance on your account cannot be taken out of CoCalc, but it does not expire and can be used at any time in the future for Pay-As-You-Go services as well as licenses and subscriptions.
